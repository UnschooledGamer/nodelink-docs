...
<TypeTable
  type={{
    ...
    eventTimeoutMs: {
      description: 'Timeout (ms) for internal event processing.',
      type: 'number',
      default: '15000'
    },
    zombieThresholdMs: {
    ...
    'audio.fading': {
      description: 'Configuration for smooth volume transitions (track start/end/stop/seek/ducking).',
      type: 'object'
    },
    enableHoloTracks: {
...
Automatic skipping of sponsored or unwanted segments in YouTube tracks, powered by the [SponsorBlock](https://sponsor.ajay.app) community database. This feature is YouTube-only; segments are fetched when a YouTube track starts playing.

<TypeTable
  type={{
    'sponsorblock.enabled': {
      description: 'Master toggle for automatic segment skipping.',
      type: 'boolean',
      default: 'false'
    },
    'sponsorblock.api': {
      description: 'SponsorBlock API base URL.',
      type: 'string',
      default: '"https://sponsor.ajay.app"'
    },
    'sponsorblock.categories': {
      description: 'Segment categories to skip (e.g. sponsor, intro, outro, selfpromo, interaction, preview, music_offtopic, filler).',
      type: 'string[]',
      default: '["sponsor","selfpromo","interaction","intro","outro","preview","music_offtopic","filler"]'
    },
    'sponsorblock.actionTypes': {
      description: 'Actions to take on matched segments.',
      type: 'string[]',
      default: '["skip"]'
    },
    'sponsorblock.skipMarginMs': {
      description: 'Skip margin in milliseconds to avoid off-by-one errors near segment boundaries.',
      type: 'number',
      default: '150'
    }
  }}
...
<TypeTable
  type={{
    ...
    'clients.playback': {
      ...
      type: 'string[]',
      default: '["AndroidVR", "TV", "WebEmbedded", "WebParentTools", "Web", "IOS"]'
    },
    'clients.resolve': {
      description: 'Clients used for resolving rich metadata.',
      type: 'string[]',
      default: '["AndroidVR", "TV", "WebEmbedded", "WebParentTools", "IOS", "Web"]'
    },
...
<TypeTable
  type={{
    ...
    sp_dc: {
      description: 'Cookie required for fetching Spotify Canvas.',
      type: 'string',
      default: '""'
    }
  }}
...
<TypeTable
  type={{
    ...
    songIfSingle: { type: 'boolean', default: 'true' },
    useApi: { type: 'boolean', default: 'true' },
    useScrapeFallback: { type: 'boolean', default: 'true' },
    preferredPlatforms: {
      type: 'string[]',
      default: '["spotify", "appleMusic", "youtubeMusic", "youtube", "deezer", "tidal", "amazonMusic", "soundcloud", "bandcamp", "audius", "audiomack", "pandora", "itunes", "amazonStore"]'
    },
    fallbackToAny: { type: 'boolean', default: 'true' }
  }}
/>
...
<TypeTable
  type={{
    enabled: { type: 'boolean', default: 'true' },
    baseUrl: { type: 'string', default: '"https://eternalboxmirror.xyz"' },
    searchResults: { type: 'number', default: '30' },
    enrichSpotify: { type: 'boolean', default: 'true' },
    includeAnalysis: { type: 'boolean', default: 'true' },
    includeAnalysisSummary: { type: 'boolean', default: 'true' },
    eternalStream: { type: 'boolean', default: 'true' },
    infiniteStream: { type: 'boolean', default: 'true' },
    cacheMaxBytes: { type: 'number', default: '20971520' }
  }}
/>
...
<TypeTable
  type={{
    enabled: { type: 'boolean', default: 'true' },
    apiUrl: { type: 'string', default: '"https://gaana.1lucas1apk.fun/api"' },
    streamQuality: { type: 'string', default: '"high"' },
    playlistLoadLimit: { type: 'number', default: '100' },
    albumLoadLimit: { type: 'number', default: '100' },
    artistLoadLimit: { type: 'number', default: '100' }
  }}
/>
...
<TypeTable
  type={{
    ...
    formatId: { 
      description: '5 = MP3 320kbps, 6 = FLAC, 27 = Hi-Res FLAC.',
      type: 'string', 
      default: '"5"' 
    },
    allowExplicit: { type: 'boolean', default: 'true' }
...
<TypeTable
  type={{
    ...
    allowExplicit: { type: 'boolean', default: 'true' },
    artistLoadLimit: { type: 'number', default: '1' },
    albumLoadLimit: { type: 'number', default: '1' },
    playlistLoadLimit: { type: 'number', default: '1' }
  }}
/>
...
<TypeTable
  type={{
    ...
    url: { 
      description: 'URL of the Piper TTS HTTP server.',
      type: 'string', 
...
Plays audio files hosted on Google Drive. Use the `gdsearch:` prefix or a direct Google Drive share URL with `/v4/loadtracks`.

<TypeTable
  type={{
    enabled: {
      description: 'Enables the Google Drive audio source.',
      type: 'boolean',
      default: 'true'
    },
    cookies: {
      description: 'Optional Cookie header string for authenticated access to private or restricted Google Drive files.',
      type: 'string',
      default: 'undefined'
    }
  }}
...
Configuration for track meaning/background providers.

<TypeTable
  type={{
    'letrasmus.enabled': {
      description: 'If true, enables Letras.mus.br meanings.',
      type: 'boolean',
      default: 'true'
    },
    'wikipedia.enabled': {
      description: 'If true, enables Wikipedia meanings.',
      type: 'boolean',
      default: 'true'
    }
  }}
...
<TypeTable
  type={{
    ...
    'letrasmus.enabled': { type: 'boolean', default: 'true' },
    'bilibili.enabled': { type: 'boolean', default: 'true' },
    'yandexmusic.enabled': { type: 'boolean', default: 'true' },
...
**Supported Providers:** YouTube, Genius, Musixmatch, LRCLib, Letras.mus.br, Bilibili, Yandex Music, Apple Music.
